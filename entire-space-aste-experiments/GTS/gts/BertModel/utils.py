...
class Metric():
    def __init__(self, args, predictions, goldens, bert_lengths, sen_lengths, tokens_ranges, all_tuple_flags,
                 ignore_index=-1, entire_space=True):
        self.args = args
        ...
        self.all_tuple_flags = all_tuple_flags
        self.ignore_index = -1
    ...
    def score_aspect(self):
        ...
        for i in range(self.data_num):
            if not self.entire_space and self.all_tuple_flags[i] == 0:
                continue
    ...
    def score_uniontags(self):
        ...
        for i in range(self.data_num):
            ...
            real_sentence_num += 1
            if len(golden_tuples) == 0 and len(predicted_tuples) == 0:
                both_zero_count += 1
