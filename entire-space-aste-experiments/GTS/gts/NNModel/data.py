...
class DataIterator(object):
    ...
    def get_batch(self, index):
        ...
        for i in range(index * self.args.batch_size,
            ...
            tuple_flags.append(self.instances[i].has_opinion)
        ...
        tuple_flags = [tuple_flags[i] for i in indexes]

        return sentence_ids, sentence_tokens, lengths, masks, aspect_tags, opinion_tags, tags, tuple_flags
