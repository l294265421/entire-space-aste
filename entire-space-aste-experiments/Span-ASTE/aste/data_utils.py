...
from aste.evaluation import LinearInstance, TagReader, nereval
from aste.utils import count_joins, get_simple_stats
...
class Sentence(BaseModel):
    ...
    def to_instance(self) -> LinearInstance:
        output = (self.pos, [t.to_raw_triple() for t in self.triples if t.label != '-'])
